...
TEMPORARY_FILE_CHANGE_FILE_BASE64 = (
    BASE64_PREFIX + base64.b64encode(TEMPORARY_FILE_CHANGE_FILE_CONTENT).decode()
)
TEMPORARY_FILE_CHANGE.seek(0)

TEMPORARY_FILE_CHANGE_CHANGED = get_temporary_file(prefix="CHANGE_CHANGED")
TEMPORARY_FILE_CHANGE_CHANGED_FILE_CONTENT = TEMPORARY_FILE_CHANGE_CHANGED.read()
TEMPORARY_FILE_CHANGE_CHANGED_FILE_BASE64 = (
    BASE64_PREFIX
...
TEMPORARY_FILE_DELETE_FILE_BASE64 = (
    BASE64_PREFIX + base64.b64encode(TEMPORARY_FILE_DELETE_FILE_CONTENT).decode()
)
